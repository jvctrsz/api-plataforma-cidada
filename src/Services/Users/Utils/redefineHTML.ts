type HtmlType = "redefinir" | "ativar";

const htmlInfo: Record<
  HtmlType,
  {
    title: string;
    message: string;
...
> = {
  redefinir: {
    ...
    message:
      "Recebemos uma solicitação para redefinir a sua senha. Clique no botão abaixo para criar uma nova senha para a sua conta.",
    alert:
  ...
  ativar: {
    ...
    message:
      "Recebemos uma solicitação para ativar a sua senha. Clique no botão abaixo para realizar a ativação da sua conta.",
    button: "Ativar Conta",
  },
};
